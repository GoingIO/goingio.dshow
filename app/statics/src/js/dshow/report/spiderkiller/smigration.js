...
require(['dataloader', 'datepicker', 'dateutil', 'toastr', 'bootstrap_table', 'd3'], function(dataloader, Datepicker, DateUtil, toastr) {
    ...
    function init(startDateStr, endDateStr) {
        dataloader.query('/log/post/nocache/s_amap_dm_user_migrate_city', {
            ...
            d3.json(DSHOW_CONTEXT + "/statics/js/dshow/report/geodata/china.json", function (json) {
