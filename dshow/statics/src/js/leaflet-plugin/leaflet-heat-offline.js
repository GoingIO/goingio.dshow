...
(function (name, context, factory) {
    ...
    var HeatmapOverlay = L.Layer.extend({
        ...
        initialize: function (config) {
            this.cfg = config;
            this.cfg.latField = this.cfg.latField || 'lat';
            this.cfg.lngField = this.cfg.lngField || 'lng';
        ...
        getRadius: function () {
            ...
            return this.cfg.zoomRadiusMap[zoom]
        },
        onAdd: function (map) {
            ...
            map.on('viewreset', this.cfg.viewreset || this._resetOrigin, this);
            // redraw whenever dragend
            map.on('dragend', this.cfg.dragend || this._draw, this);
            map.on('resize', this.cfg.resize || function () {
